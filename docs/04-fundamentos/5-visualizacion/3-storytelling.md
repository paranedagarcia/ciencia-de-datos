---
id: storytelling
title: "Storytelling en Ciencia de Datos"
...
El **storytelling con datos**, o data storytelling, representa una evolución fundamental en la comunicación de información dentro del ámbito de la ciencia de datos. No se trata simplemente de presentar cifras o crear gráficos atractivos; es una disciplina que combina tres pilares interconectados para transformar datos complejos en mensajes comprensibles, memorables y accionables. 

Es el proceso de traducir el análisis de datos a un formato narrativo para facilitar la comunicación de hallazgos y apoyar la toma de decisiones. Se define como el puente entre la visualización de datos (que responde al "qué") y la narrativa (que responde al "por qué").

Los tres elementos clave son los **datos**, la **visualización** y la **narrativa**. Los datos proporcionan la base empírica y la evidencia factual sobre la que se asienta toda la historia. La visualización actúa como el vehículo que ilumina y organiza esta información, haciéndola tangible y fácilmente digestible. Finalmente, la narrativa es el hilo conductor que da contexto, estructura y significado a los datos y las visualizaciones, conectando emocionalmente con la audiencia y guiándola hacia una conclusión o acción deseada.

### Orígenes: De las cavernas a la estadística moderna
Aunque el término es contemporáneo, la práctica de comunicar información mediante imágenes es inherente a la humanidad:

*   **Prehistoria:** La visualización de información comenzó hace más de 32,000 años con las pinturas rupestres en la **cueva de Chauvet**, donde se registraban aspectos de la vida humana.

*   **Hitos Históricos:** 
*   En el siglo II (150 d.C.), **Claudio Ptolomeo** utilizó tablas de datos para mostrar información astronómica. 

*   A finales del siglo XVIII, **William Playfair** inventó el gráfico de barras, de líneas y de sectores para representar datos económicos. 

*   En el siglo XIX surgieron trabajos icónicos como el mapa de la epidemia de cólera de **John Snow** (1854) y el gráfico de **Florence Nightingale** (1858) sobre la mortalidad en la guerra de Crimea.

*   **Charles Joseph Minard** publicó en 1869 el mapa de flujo de la marcha de Napoleón hacia Rusia, considerado uno de los mejores ejemplos de narrativa visual por su capacidad de contar una tragedia humana mediante datos estadísticos.

### Efectos: La ciencia detrás de la historia
...
:::warning[Importante]
El objetivo no es explorar, sino comunicar una narrativa coherente que respalde una decisión o cambie una percepción.
:::
...
![Piramide de Freytag](img/st-freytag.png)
...
![](img/st-sap.jpg "https://www.sap.com/spain/products/data-cloud/cloud-analytics/what-is-data-storytelling.html")
