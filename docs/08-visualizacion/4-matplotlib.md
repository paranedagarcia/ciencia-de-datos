...
<details>
<summary>**Obtención de datos desde web** (ver código)</summary>
...
<details>
<summary>**Evolución de casos de Covid-19** (ver código)</summary>
```python showLineNumbers
import matplotlib.pyplot as plt
import numpy as np
...
<details>
<summary>**Grilla de casos acumulados** (ver código)</summary>
```python showLineNumbers
import matplotlib.pyplot as plt
import numpy as np
import matplotlib.font_manager as fm
...
<details>
<summary>**Manejo de fechas** (ver código)</summary>
```python showLineNumbers
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
